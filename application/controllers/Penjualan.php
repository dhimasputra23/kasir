...
class Penjualan extends CI_Controller 
{
    ...
    {
        $destroy_cookie=$this->input->post('destroy_cookie');
            ...
            if(!empty($total) && !empty($jml_uang) && !empty($nohp))
            {
                ...
                else
                {
                    ...
                    if($order_proses)
                    {
                        ...
                        redirect('penjualan/cetak_faktur');	
            ...
            if(!empty($total) && !empty($jml_uang) && !empty($nohp))
            {
                ...
                if( $destroy_cookie == "" ) {
                    ...
                    if($order_proses){
                        ...
                        redirect('penjualan/cetak_faktur_dp');	
