                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="badge badge-danger" href="#modal-hapus<?= $id_rusak; ?>" data-toggle="modal" title="Hapus"><span class="fas fa-fw fa-trash"></span> Hapus</a>
                        </td>
                    </tr>
...
<div class="modal fade" id="modal-edit<?= $x->id_barang_rusak; ?>">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" readonly value="<?=$x->id_barang_rusak;?>" name="id" class="form-control" >
      
      <div class="form-group">
              <label for="Kategori">Nama Barang : </label>
                  <select required name="barang" id="barang" class="form-control">
                              <option value='<?= $x->id_barang; ?>'><?= $x->barang_nama; ?></option>";
                  </select>
          </div>
...
<?php endforeach;?>
  ...
  <?php $no=0; foreach($data->result() as $x): $no++; ?>
    ...
    <div class="modal fade" id="modal-hapus<?= $x->id_barang_rusak; ?>">
      <div class="modal-dialog">
