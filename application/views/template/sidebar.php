...
<!-- Nav Item - Karyawan -->
<li class="nav-item">
  <a class="nav-link" href="<?php echo site_url('hutang_karyawan'); ?>">
    <i class="fas fa-balance-scale"></i>
    <span>Hutang Karyawan</span></a>
</li>
<!-- AHKHIR DATA TOKO -->
      <?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('peminjaman_barang'); ?>">Data Peminjaman Barang</a>
          </div>
        </div>
      </li>
      <!-- AKHIR DATA BARANG -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('penjualan/in_penjualan'); ?>">Penjualan</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('Pembelian/in_pembelian'); ?>">Pembelian Barang</a>
