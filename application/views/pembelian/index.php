      ...
      <?php } ?>      
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                        ...
                        ?>
                        <input type="text" name="nofak" value="<?= $kode_belii; ?>" class="form-control" placeholder="No Faktur" readonly>
                    </div>
                ...
                <table width="100%;">
                  <tr>
                      <th>Nama Barang :</th>  
                      <th>
                        <input type="text" list="list_barang" autocomplete="off" name="nabar" id="nabarku" class="form-control input-sm">
                ...
                <div class="table-responsive">
                  <table width="100%" id="detail_barang" cellpadding="6"></table>
                </div>
              </div> 
              </form>
                <hr>
